...
Every example also pins `geolens-mcp@1.15.0`, the current release and the version the demo reports.
...
itself healthy at 1.13.0; the tool set is unchanged in 1.15.0). Output is real and trimmed for width.
