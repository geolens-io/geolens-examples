...
Every example also pins `geolens-mcp@1.16.1`, the current release and the version the demo reports.
...
itself healthy at 1.13.0; the tool set is unchanged in 1.16.1). Output is real and trimmed for width.
