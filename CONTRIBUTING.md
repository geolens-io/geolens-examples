...
- Comment the *why*, not the *what*. The existing examples explain things like why a raster layer needs CORS headers and a vector one doesn't, or why OpenLayers reprojects GeoJSON automatically, not what `new ol.Map(...)` does.
