...
<p align="center">
  ...
  <a href="qgis/"><img src="assets/qgis-window.jpg" width="32%" alt="QGIS with the demo's subway stations, subway lines and Matterhorn DEM added through one OGC API Features connection" /></a>
...
4. **Build a map.** Add layers from the catalog, style each one, set the viewport, save ([map builder guide](https://docs.getgeolens.com/guides/user/map-builder/)). The [showcase maps](https://demo.getgeolens.com/maps) on the demo were made this way.
