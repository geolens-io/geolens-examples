...
```js
import { createGeolensClient } from "https://esm.sh/@geolens/sdk@1.16.0";
```
...
`@geolens/sdk@1.16.0` (current npm release) and `maplibre-gl@5.24.0`, verified
against the live demo (serving 1.16.0) on 2026-08-27: SDK loaded from
