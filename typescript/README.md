...
```js
import { createGeolensClient } from "https://esm.sh/@geolens/sdk@1.16.1";
```
...
`@geolens/sdk@1.16.1` (current npm release) and `maplibre-gl@5.24.0`, verified
against the live demo (serving 1.16.1) on 2026-08-28: SDK loaded from
